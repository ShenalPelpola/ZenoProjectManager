#pragma checksum "C:\Users\Acer\source\repos\Zeno\ZenoProjectManager\Client\Shared\SideNavBar.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c83e3209870134afd23243730a0804630c3426f7"
// <auto-generated/>
...
#nullable disable
    ...
    <ul class=""navbar-nav d-flex flex-column mt-4 w-100""><li class=""nav-item w-100""><a href class=""nav-link text-dark pl-4""><i class=""fas fa-project-diagram""></i>
                <span class=""px-2"">Projects</span></a></li>
        <li class=""nav-item w-100""><a href class=""nav-link text-dark pl-4""><i class=""fas fa-users""></i>
                <span class=""px-2"">Users</span></a></li>
        <li class=""nav-item w-100""><a href class=""nav-link text-dark pl-4""><i class=""fas fa-clipboard-list""></i>
                <span class=""px-2"">Report</span></a></li>
        <li class=""nav-item w-100""><a href class=""nav-link text-dark pl-4""><i class=""fas fa-chart-line""></i>
                <span class=""px-2"">Predictions</span></a></li></ul></nav>");
        }
