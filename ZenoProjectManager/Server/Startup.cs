...
namespace ZenoProjectManager.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(opt =>
            {
                opt.SwaggerDoc("v1",
                    ...
                    {
                        Title = "Zeno Project Manager server",
                        Description = "The server side(API) CRUD operations for zeno project manager",
                        Version = "v1"
                    }
                 );
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                opt.SwaggerEndpoint("/swagger/v1/swagger.json", "Zemo Project Manager");
            });
        }
    }
}
